...
//        window.setFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS, WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
    ...
    private class ScreenSlideAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            Group5Fragment group5Fragment = null;
            switch (position) {
                case 0:
                    group5Fragment = Group5Fragment.newInstance(R.layout.group5_content1);
                    break;
                case 1:
                    group5Fragment = Group5Fragment.newInstance(R.layout.group5_content2);
                    break;
                case 2:
                    group5Fragment = Group5Fragment.newInstance(R.layout.group5_content3);
                    break;
                case 3:
                    group5Fragment = Group5Fragment.newInstance(R.layout.group5_content4);
                    break;
                case 4:
                    group5Fragment = Group5Fragment.newInstance(R.layout.group5_content5);
                    break;
                case 5:
                    group5Fragment = Group5Fragment.newInstance(R.layout.group5_content6);
                    break;
            }

            return group5Fragment;
        }
