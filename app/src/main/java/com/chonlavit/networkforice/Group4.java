...
//        window.setFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS, WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
        ...
        setContentView(R.layout.home_group4);
    ...
    private class ScreenSlideAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            Group4Fragment group4Fragment = null;
            switch (position) {
                case 0:
                    group4Fragment = Group4Fragment.newInstance(R.layout.group4_content_1);
                    break;
                case 1:
                    group4Fragment = Group4Fragment.newInstance(R.layout.group4_content_2);
                    break;
                case 2:
                    group4Fragment = Group4Fragment.newInstance(R.layout.group4_content_3);
                    break;
                case 3:
                    group4Fragment = Group4Fragment.newInstance(R.layout.group4_content_4);
                    break;
            }

            return group4Fragment;
        }
