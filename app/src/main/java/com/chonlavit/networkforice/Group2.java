...
//        window.setFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS, WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
        ...
        setContentView(R.layout.home_group2);
    ...
    private class ScreenSlideAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            Group2Fragment group2Fragment = null;
            switch (position) {
                case 0:
                    group2Fragment = Group2Fragment.newInstance(R.layout.group2_content_1);
                    break;
                case 1:
                    group2Fragment = Group2Fragment.newInstance(R.layout.group2_content_2);
                    break;
                case 2:
                    group2Fragment = Group2Fragment.newInstance(R.layout.group2_content_3);
                    break;
                case 3:
                    group2Fragment = Group2Fragment.newInstance(R.layout.group2_content_4);
                    break;
            }
