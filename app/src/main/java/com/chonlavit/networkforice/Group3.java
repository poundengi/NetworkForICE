...
//        window.setFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS, WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
        ...
        setContentView(R.layout.home_group3);
    ...
    private class ScreenSlideAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            Group3Fragment group3Fragment = null;
            switch (position) {
                case 0:
                    group3Fragment = Group3Fragment.newInstance(R.layout.group3_content_1);
                    break;
                case 1:
                    group3Fragment = Group3Fragment.newInstance(R.layout.group3_content_2);
                    break;
                case 2:
                    group3Fragment = Group3Fragment.newInstance(R.layout.group3_content_3);
                    break;
                case 3:
                    group3Fragment = Group3Fragment.newInstance(R.layout.group3_content_4);
                    break;
                case 4:
                    group3Fragment = Group3Fragment.newInstance(R.layout.group3_content_5);
                    break;
                case 5:
                    group3Fragment = Group3Fragment.newInstance(R.layout.group3_content_6);
                    break;
            }

            return group3Fragment;
        }
